 ...
 */
class Supplier extends Action implements HttpPostActionInterface
{
    private const PAGE_URL = '/become-a-supplier';
    private const EMAIL_TEMPLATE = 'become-a-supplier';
