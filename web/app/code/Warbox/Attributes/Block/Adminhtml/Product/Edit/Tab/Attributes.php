...
namespace Warbox\Attributes\Block\Adminhtml\Product\Edit\Tab;
 ...
 * Class Attributes
 *
 * @package Warbox\Attributes\Block\Adminhtml\Product\Edit\Tab
 */
        ...
        if ($group) {
            ...
            if ($tierPrice) {
                $tierPrice->setRenderer(
                    $this->getLayout()->createBlock(Tier::class)
                );
            }
